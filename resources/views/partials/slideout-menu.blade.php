<div class="slideout">
	...
	<div class="slideout-body" style="border-bottom: 1px solid rgba(0,0,0,0.12)">
		<ul class="list-group">
			...
			<li class="list-group-item"><a href=""><i class="fa fa-list"></i><strong><small>Categories</small></strong></a></li>
			<li class="list-group-item clearfix"><a href=""><i class="fa fa-bell"></i><strong><small>notifications <span class="badge">3</span></small></strong></a></li>
