<div class="slideout">
	<div class="slideout-header clearfix">
		...
		@else
			<ul class="slideout-cta">
				<li><a href="{{ url('register') }}" class="btn __btn __btn-cta __btn-blue"><strong>register</strong></a></li>
				<li><a href="{{ url('login') }}" class="btn __btn __btn-cta __btn-green"><strong>login</strong></a></li>
			</ul>
		@endif
	</div>
	<div class="slideout-body" style="border-bottom: 1px solid rgba(0,0,0,0.12)">
		<ul class="list-group">
			...
			<li class="list-group-item">
				<a href="" class="main-menu"><i class="fa fa-list"></i><strong><small>Articles</small></strong><span class="caret"></span></a>
				<ul class="sub-menu">
					<li><a href="#">Life</a></li>
